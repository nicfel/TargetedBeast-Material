...
fasta_file <- "pathoplexusData/west-nile_aligned-nuc_2025-01-31T1944.fasta"
metadata_file <- "pathoplexusData/west-nile_metadata_2025-01-31T1944.tsv"
...
output_file <- "fasta/wnv_all.fasta"
